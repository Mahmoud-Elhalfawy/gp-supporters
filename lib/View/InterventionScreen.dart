...
class _InterventionScreenState extends State<InterventionScreen> {
  ...
  Future<void> save(Map<String,dynamic> dataToBackend, AsyncSnapshot<QuerySnapshot> snapshot) async{
    ...
    if(snapshot.data!.docs.where((element) => element['row']==dataToBackend['row'] && element['hCode']==widget.code).isEmpty) {
      ...
      await FirebaseFirestore.instance.collection(InterventionSheetKeys.table).doc(checkedValue?.reference.id).update(dataToBackend);
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        ...
        stream: FirebaseFirestore.instance.collection(InterventionSheetKeys.table).snapshots(),
