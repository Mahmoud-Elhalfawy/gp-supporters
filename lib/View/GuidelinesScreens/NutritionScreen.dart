...
class NutritionScreen extends StatefulWidget {
  ...
  static String id="nutrition screen";
  static String code='';
        ...
        appBar: AppBar(
            ...
            bottom:   TabBar(
              ...
              tabs:  [
                ...
                Tab(text:Nutrition.option1),
                Tab(text:Nutrition.option2),
        ...
        body: Container(
          ...
          child:  TabBarView(
            children: [
              ...
              GuidelinesListScreen(type: "nutrition", subType: Nutrition.option1,),
              GuidelinesListScreen(type: "nutrition", subType: Nutrition.option2,),
